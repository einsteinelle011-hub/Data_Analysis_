# Generated by Django 5.0.7 on 2025-10-27 06:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='deepseek_api.conversationsession')),
            ],
            options={
                'indexes': [models.Index(fields=['session', 'timestamp'], name='deepseek_ap_session_2967e6_idx')],
            },
        ),
        migrations.CreateModel(
            name='RateLimit',
